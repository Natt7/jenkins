...
@Component({
  templateUrl: './delivery-success-cargo.component.html',
  styleUrls: ['./delivery-success-cargo.component.css'],
  providers: [ApiService],
  animations: [fadeInAnimation]
})
export class DeliverySuccesCargoComponent implements OnInit {
  address = {
    id: null,
    name: '',
    mobile: '',
  ...
  ngOnInit(): void {
    Observable.from(this.route.params)
      ...
      combine.subscribe(data => {
        ...
        this.orderService.successCargoDelivery(this.deliveryId).subscribe(res => {
